...
def build_vlsi_graph(data_dir):
    # Pointing to bigblue1 specifically
    nodes_file = os.path.join(data_dir, "bigblue1.nodes")
    nets_file = os.path.join(data_dir, "bigblue1.nets")
    
    node_map = {}
    node_features = []
    
    print("Step 1: Parsing Nodes and Dimensions for BigBlue1...")
...
if __name__ == "__main__":
    ...
    data_path = os.path.expanduser("~/vlsi_ai_project/data/bigblue1")
    ...
    if not os.path.exists(data_path):
        ...
        torch.save(vlsi_graph, 'bb_processed_graph.pt')
        print("\nbuild_graph_bb.py: Success! Saved 'bb_processed_graph.pt'.")
